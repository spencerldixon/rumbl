defmodule Rumbl.AuthTest do
  ...
  test "call with no session gets current user set to nil", %{conn: conn} do
  ...
  test "login with user not found", %{conn: conn} do
    assert {:error, :not_found, _conn} = Auth.login_by_username_and_pass(conn, "me", "wrong", repo: Repo)
  end
